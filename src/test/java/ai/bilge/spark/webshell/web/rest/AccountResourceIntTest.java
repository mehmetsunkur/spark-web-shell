...
import ai.bilge.spark.webshell.config.Constants;
import ai.bilge.spark.webshell.SparkWebShellApp;
import ai.bilge.spark.webshell.domain.Authority;
import ai.bilge.spark.webshell.domain.User;
import ai.bilge.spark.webshell.repository.AuthorityRepository;
import ai.bilge.spark.webshell.repository.UserRepository;
import ai.bilge.spark.webshell.security.AuthoritiesConstants;
import ai.bilge.spark.webshell.service.MailService;
import ai.bilge.spark.webshell.service.dto.UserDTO;
import ai.bilge.spark.webshell.web.rest.errors.ExceptionTranslator;
import ai.bilge.spark.webshell.web.rest.vm.KeyAndPasswordVM;
import ai.bilge.spark.webshell.web.rest.vm.ManagedUserVM;
import ai.bilge.spark.webshell.service.UserService;
