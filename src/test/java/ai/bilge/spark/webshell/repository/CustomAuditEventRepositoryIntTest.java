...
import ai.bilge.spark.webshell.config.audit.AuditEventConverter;
import ai.bilge.spark.webshell.domain.PersistentAuditEvent;
...
import static ai.bilge.spark.webshell.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
