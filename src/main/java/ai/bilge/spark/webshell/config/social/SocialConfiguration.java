package ai.bilge.spark.webshell.config.social;

import ai.bilge.spark.webshell.repository.SocialUserConnectionRepository;
import ai.bilge.spark.webshell.repository.CustomSocialUsersConnectionRepository;
import ai.bilge.spark.webshell.security.jwt.TokenProvider;
import ai.bilge.spark.webshell.security.social.CustomSignInAdapter;
